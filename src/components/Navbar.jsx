        ...
        <nav className={`flex justify-center lg:justify-between items-center px-4 md:px-8 lg:px-12 py-4 max-w-full mx-auto relative ${i18n.language === 'he' ? 'rtl' : 'ltr'}`}>
          ...
          <div className="flex flex-wrap justify-center items-center gap-5 sm:gap-8 md:gap-12 lg:gap-16 w-full lg:w-auto">
            ...
            <button 
              ...
              className="font-label-sm uppercase tracking-[0.1em] text-[0.7rem] sm:text-xs text-primary hover:text-secondary transition-all cursor-pointer select-none border border-outline-variant/40 hover:border-primary/60 px-3 py-1 rounded-[20px] bg-white/40 backdrop-blur-sm focus:outline-none ml-2"
            >
