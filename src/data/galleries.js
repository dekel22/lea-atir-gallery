...
export const galleries = [
  ...
  },
  {
    ...
    "longDescription": "זוהי תקופה בה הלכתי לרשום מודל עירום במסגרת מוזיאון חיפה. העבודות נעשו ב-25-30 דקות כל עבודה, באקריליק לייבוש מהיר, במונוכרום.\n\nיש בעירום איזושהי חשיפה של הגוף והתעסקות מעניינת עם העור עצמו, עם קיצורי פרופורציות, יצירת הנפח או הלחץ, עיוותים ואתגר של בניית כתם על הגוף, וכמובן מיקומו על הדף.",
  ...
  },
  {
    ...
    "title": "בין לבין",
    "description": "",
    "longDescription": "\"בין לבין\" הוא מרחב של אי-ודאות, פתוח, מקום של אפשרויות. לרוב זהו מצב של סיום אמירה, תוכן כלשהו או סיכום עבודה בתערוכה. מצב ביניים לאחר סיום של פרק אחד ומעבר לפרק אחר. \n\nזה לא מצב של חוסר עשייה - זהו מצב פעיל של חשיבה, חיפוש והקשבה. בעצם השהייה במצב הזה יש הנאה משחררת. שום עבודה היא לא לחינם; \"בין לבין\" הוא תמיד מלא בתוכן. \n\nהפעם יצאתי מתוך סקיצות מהירות קטנות שאני רושמת כל הזמן כמהלך שגרתי. מתוך בלוקים קטנים של רישום בדרך: את עצמי במראה, את מיקי קורא עיתון (תנוחה פופולרית מאוד), ולפעמים חלק נוף שאני משלימה על-פי הזיכרון. לעיתים רישום שרשמתי אני מעבדת מספר פעמים, יוצרת ממנו וריאציה או אלתור, כמו במוזיקה על-פי תבנית.",
