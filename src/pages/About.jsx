        ...
        <div className="lg:col-span-8 space-y-8 text-on-surface">
          <div className="space-y-6">
            <p className="font-body-lg text-body-lg leading-relaxed">
              סיימתי את לימודיי בתל אביב ומיד בחרתי לקחת אחריות על כל העשייה שלי. בראש ובראשונה להיות המבקרת של עצמי, להחליט מהם הנושאים,  סגנון  העבודה, בחרתי בד בבד ללמד כדי לא להיות תלויה במכירת העבודות שלי  למחיה. כך היה כל השנים , תמיד ציירתי בלי שהתערבו לי בהחלטות. עד היום הצגתי למעלה מ23 תערוכות יחיד ומשותפות.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-8 border-t border-surface-variant/30">
            <div>
              ...
              <ul className="space-y-2 font-body-md text-on-surface-variant">
                ...
                <li>• התנדבות הוראה לאנשים עם מוגבלויות</li>
                <li>• מתנדבת בבני ברית.</li>
              </ul>
            </div>
            <div>
