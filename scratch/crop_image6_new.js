...
console.log("Cropping file:", fullPath);

// New crop parameters to keep the left side intact:
const cropX = 15;
const cropY = 15;
const cropW = 1135; // 1150 - 15
const cropH = 890;  // 905 - 15
...
try {
  console.log("Running new crop in PowerShell...");
